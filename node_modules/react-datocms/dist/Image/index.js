...
exports.Image = function (_a) {
    ...
    return (react_1["default"].createElement("div", { ref: ref, className: className, style: __assign(__assign({ display: explicitWidth ? "inline-block" : "block", overflow: "hidden" }, style), { position: "relative" }) },
        sizer,
        placeholder,
        addImage && (react_1["default"].createElement("picture", { style: __assign(__assign({}, absolutePositioning), { opacity: showImage ? 1 : 0, transition: !fadeInDuration || fadeInDuration > 0
        ...
        react_1["default"].createElement("noscript", null,
            react_1["default"].createElement("picture", { className: pictureClassName, style: __assign({}, pictureStyle) },
                webpSource,
                regularSource,
